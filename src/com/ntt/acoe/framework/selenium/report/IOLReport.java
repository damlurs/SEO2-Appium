...
public class IOLReport {
	...
	private static String getHTMLHeader() {
		return "<html><head><title>Test Report</title>" + "<style>" + "body {background-color: lightgray; font-family:verdana;}"
				+ "#report table{width:95%; margin-left:2%; border-width:1px; border-style: solid; border-collapse: collapse; colspan: 0px;}" + "#report table caption{font-size: 30px;}"
				+ "#report table th{ border-width:1px; border-style: solid; border-color: white; color: white; background-color: #086FA1; padding: 2px; font-size: 80%;}"
				+ "#report table td{ border-width:1px; border-style: solid; border-color: white; background-color: #FFC840;  padding: 2px; font-size: 80%;}"
	...
	private static String getTableHeader() {
		return "<table><tr><th>S.No</th><th>TC Id</th><th width=\"\5%\">TC Name</th><th>Test Case Status</th><th>Step</th><th>Description</th><th>Expected</th><th>Actual</th><th>Step Status</th></tr>";
	}

	private static String getFilesTable() {
		return "<table>" + "<caption>IOL Test Report</caption>" + "<tr><td>Total Steps:</td><td>" + testResult1.size() + "</td></tr>" + "<tr><td>Steps Passed:</td><td>" + getPassCount() + "</td></tr>"
